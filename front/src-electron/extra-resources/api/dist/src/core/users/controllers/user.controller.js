...
let UserController = class UserController extends base_controller_1.BaseController {
  ...
  async update(req, body) {
    ...
    const user = await this.service.update(
      Object.assign(Object.assign({}, body), { id: userId })
    );
    if (!user) {
...
__decorate(
  [
    ...
    (0, roles_decorator_1.Roles)(
      user_role_enum_1.UserRoleEnum.User,
      ...user_role_enum_1.allMainUsers
    ),
    __param(0, (0, common_1.Req)()),
    __param(
      1,
      (0, common_1.Param)('username', new common_1.DefaultValuePipe(undefined))
    ),
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      Object,
      user_patch_dto_1.UserUpdateCurrentDto,
    ]),
    __metadata('design:returntype', Promise),
  ],
  UserController.prototype,
