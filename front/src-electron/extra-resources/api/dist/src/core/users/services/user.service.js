...
let UserService = class UserService extends base_service_1.BaseService {
    constructor(repository, userJwtService) {
        ...
        this.resetPasswordToken = new reset_password_token_1.ResetPasswordToken(this, repository, userJwtService);
    }
    ...
    async chooseNewPasswordAfterReset(userId, newPassword) {
        ...
        if (!user.resetPasswordOngoing) {
            throw new common_1.InternalServerErrorException('Un reset doit être en cours pour que cette opération fonctionne');
        }
        ...
        if (!newUser) {
            throw new common_1.NotFoundException("Le nouvel utilisateur n'a pas été trouvé");
        }
        return newUser;
    }
    async askForResetPassword(userId) {
        ...
        if (!isValid) {
            throw new common_1.InternalServerErrorException(`Le mot de passe n'a pas pu être généré, veuillez essayer à nouveau.`);
        }
    ...
    async create(dto) {
        ...
        const userJwt = await this.userJwtService.create(Object.assign(Object.assign({}, userJwtDto), { activated: true }), false);
        delete dto.userJwt;
    ...
    async update(dtoToBeUpdated) {
        ...
        if (!existingDto)
            return;
        const updatedDto = Object.assign(Object.assign({}, existingDto), dtoToBeUpdated);
    ...
    async updateAdmin(dtoToBeUpdated) {
        ...
        if (!existingDto)
            return;
        const isAdminUser = (_a = existingDto.roles) === null || _a === void 0 ? void 0 : _a.includes(user_role_enum_1.UserRoleEnum.Admin);
        const newUserHaveNotAdminRole = !((_b = dtoToBeUpdated.roles) === null || _b === void 0 ? void 0 : _b.includes(user_role_enum_1.UserRoleEnum.Admin));
        if (isAdminUser && newUserHaveNotAdminRole)
            (_c = dtoToBeUpdated.roles) === null || _c === void 0 ? void 0 : _c.unshift(user_role_enum_1.UserRoleEnum.Admin);
        const updatedDto = Object.assign(Object.assign({}, existingDto), dtoToBeUpdated);
        const savedDto = await this.repository.save(updatedDto);
        return new user_entity_1.User(Object.assign({}, savedDto));
    }
    async delete(id) {
        ...
        if (userToBeDeleted && userToBeDeleted.userJwt) {
            userToBeDeleted.userJwt.username = `softDeleted_${userToBeDeleted === null || userToBeDeleted === void 0 ? void 0 : userToBeDeleted.userJwt.id}_${userToBeDeleted === null || userToBeDeleted === void 0 ? void 0 : userToBeDeleted.userJwt.username}`;
    ...
    async findAndPaginateWithOptions(paginationOptions, searchOptions) {
        ...
        if (searchOptions === null || searchOptions === void 0 ? void 0 : searchOptions.includes) {
            relations = [...relations, ...searchOptions.includes];
        }
        const conditions = [];
        if (searchOptions) {
            if ((_a = searchOptions === null || searchOptions === void 0 ? void 0 : searchOptions.roles) === null || _a === void 0 ? void 0 : _a.length) {
                const cond = {
                    type: conditions.length > 0 ? base_repositories_1.TypeEnum.AND : undefined,
                    conditions: searchOptions === null || searchOptions === void 0 ? void 0 : searchOptions.roles.map((role) => ({
            ...
            if ((searchOptions === null || searchOptions === void 0 ? void 0 : searchOptions.search) && searchOptions.search !== '%') {
        ...
        return this.findAndPaginate(Object.assign(Object.assign({}, paginationOptions), { conditions,
            relations }));
    }
};
