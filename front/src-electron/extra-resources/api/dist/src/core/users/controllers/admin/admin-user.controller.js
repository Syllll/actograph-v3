...
let AdminUserController = class AdminUserController extends base_controller_1.BaseController {
    ...
    async getWithPagination(searchQueryParams, relations = [], searchString, filterRoles = []) {
    ...
    async create(body) {
        var _a;
        try {
            if ((_a = body.userJwt) === null || _a === void 0 ? void 0 : _a.username) {
                const usernameExists = await this.userJwtService.findByUsername(body.userJwt.username);
                if (usernameExists) {
                    throw new common_1.HttpException('Un utilisateur existe déjà avec ce nom, essayez autre chose', common_1.HttpStatus.BAD_REQUEST);
                }
            }
            ...
            console.error(err);
            throw new common_1.HttpException('Creation impossible', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async update(body) {
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('includes', new ParseEnumArray_pipe_1.ParseEnumArrayPipe({
        type: ['userJwt'],
        separator: ',',
    }))),
    __param(2, (0, common_1.Query)('searchString', new common_1.DefaultValuePipe('*'), ParseFilter_pipe_1.ParseFilterPipe)),
    __param(3, (0, common_1.Query)('filterRoles', new ParseEnumArray_pipe_1.ParseEnumArrayPipe({
        type: ['admin', 'user'],
        separator: ',',
    }))),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], AdminUserController.prototype, "getWithPagination", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, user_roles_guard_1.UserRolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRoleEnum.Admin),
    ...
    __metadata("design:returntype", Promise)
], AdminUserController.prototype, "getOne", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_create_for_admin_dto_1.UserCreateForAdminDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [admin_user_patch_dto_1.AdminUserUpdateDto]),
    __metadata("design:returntype", Promise)
