...
let UserCreatedListener = class UserCreatedListener {
    ...
    async handleUserCreatedEvent(event) {
        try {
            ...
            throw new common_1.InternalServerErrorException('Create from google error');
        }
    }
};
__decorate([
    ...
    __metadata("design:paramtypes", [authJwtUserCreated_event_1.authJwtUserCreatedEvent]),
    __metadata("design:returntype", Promise)
], UserCreatedListener.prototype, "handleUserCreatedEvent", null);
