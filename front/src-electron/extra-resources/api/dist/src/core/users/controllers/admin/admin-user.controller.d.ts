...
export declare class AdminUserController extends BaseController {
    ...
    getAll(): Promise<User[]>;
    getWithPagination(searchQueryParams: ISearchQueryParams, relations: string[] | undefined, searchString: string, filterRoles?: string[]): Promise<IPaginationOutput<User>>;
