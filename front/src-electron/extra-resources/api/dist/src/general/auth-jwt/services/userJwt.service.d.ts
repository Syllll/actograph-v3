...
export declare class UserJwtService {
    ...
    constructor(userJwtRepository: UserJwtRepository, eventEmitter: EventEmitter2, jwtService: JwtService);
    create(userCreateDto: UserJwtCreateDto, emitUserCreateSignal?: boolean): Promise<Pick<UserJwt, 'id' | 'username'>>;
    ...
    sendMailForNewPassword(email: string, resetPasswordUrl: string): Promise<UserJwt>;
    findByRecuperationToken(token: string): Promise<UserJwt>;
    changePasswordUser(token: string, password: string): Promise<{
        user: UserJwt | null;
    }>;
