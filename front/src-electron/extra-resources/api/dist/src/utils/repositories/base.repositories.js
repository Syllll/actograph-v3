...
class BaseRepository extends typeorm_1.Repository {
  ...
  async findAndFilter2(options) {
    ...
    const results = await this.findAndFilter(
      {
        conditions:
          (_a = options.conditions) !== null && _a !== void 0 ? _a : [],
      },
      options.relations,
      options.limit,
      options.offset,
  ...
  async findAndFilter(
    ...
    for (const relation of relations) {
      ...
      if (
        (relationSplitted === null || relationSplitted === void 0
          ? void 0
          : relationSplitted.length) > 1
      ) {
  ...
  processQuery(qb, tableName, conditions, recursionIndex = 0) {
    ...
    for (let i = 0, ie = conditions.length; i < ie; i = i + 1) {
      ...
      if (cond.conditions && cond.conditions.length > 0) {
          ...
          qb.where(
            new typeorm_1.Brackets((qb) => {
              ...
              this.processQuery(
                qb,
                tableName,
                (_a = cond.conditions) !== null && _a !== void 0 ? _a : [],
                ++recursionIndex
              );
            })
          );
        ...
        let myCondName = `myCond_${recursionIndex}_${i}_${
          (_a = cond.key) === null || _a === void 0
            ? void 0
            : _a.replace(/\./g, '_')
        }`;
        ...
        const accentInsensitive =
          (_b = cond.unaccent) !== null && _b !== void 0 ? _b : false;
        const caseInsensitive =
          (_c = cond.caseless || cond.unaccent) !== null && _c !== void 0
            ? _c
            : false;
