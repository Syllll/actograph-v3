...
exports.SearchQueryParams = (0, common_1.createParamDecorator)(async (data = {
    pagination: true,
    useQ: true,
}, ctx) => {
    ...
    if (data.pagination) {
        ...
        output = Object.assign(Object.assign({}, output), { limit: limit || 10, offset: offset || 0, orderBy: orderBy || 'id', order: order || 'DESC' });
    }
    if (data.useQ) {
