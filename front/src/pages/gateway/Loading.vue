...
export default defineComponent({
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            while (!isServerRunning && new Date().getTime() - start.getTime() < timeout) {
            ...
            if (!isServerRunning) {
                state.error = "Erreur lors de l'initialisation de l'application, code=1";
                state.loading = false;
                return;
            }
            ...
            try {
                ...
                state.error = "Erreur lors de l'initialisation de l'application, code=2";
                state.loading = false;
                return;
            }
