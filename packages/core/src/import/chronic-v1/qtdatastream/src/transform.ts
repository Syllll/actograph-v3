...
import { ReadBuffer, CustomBuffer } from './buffer';
...
class ReadTransform extends Transform {
  constructor() {
    super(
      Object.assign({ readableObjectMode: true, writableObjectMode: false }),
    );
    this.packet_no = 0;
...
class WriteTransform extends Transform {
  constructor() {
    super(
      Object.assign({ readableObjectMode: false, writableObjectMode: true }),
    );
  }
