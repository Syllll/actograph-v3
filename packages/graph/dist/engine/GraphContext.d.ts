import type { IGraphPreferences, IObservation, IPeriod, IProtocol, IReading } from '@actograph/core';
...
export interface GraphContext {
    ...
    readonly getObservablePreferences: (category: ProtocolItem, observableName: string) => IGraphPreferences | null;
