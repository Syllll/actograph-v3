...
const SEMITRANSPARENT_POINTER_SVG = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">' +
...
export const GRAPH_CANVAS_CURSOR_IDLE = `url("data:image/svg+xml,${encodeURIComponent(SEMITRANSPARENT_POINTER_SVG)}") 4 4, crosshair`;
/** Cursor while panning the graph viewport. */
export const GRAPH_CANVAS_CURSOR_PANNING = 'grabbing';
//# sourceMappingURL=graph-cursor.constants.js.map