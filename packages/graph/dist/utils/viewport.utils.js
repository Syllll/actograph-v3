...
export function isDegenerateCanvasSize(width, height) {
 ...
 */
export function computeFitViewportPosition(worldBounds, canvasSize, scaleX, scaleY) {
 ...
 */
export function anchorZoomTranslation(screenX, screenY, worldX, worldY, newScale, axisStretch) {
    return {
