import { BackgroundPatternEnum, DisplayModeEnum, ProtocolItemActionEnum, ReadingTypeEnum, isCategoryVisible, resolveGraphColor, } from '@actograph/core';
...
export class FriezeLayer extends BaseLayer {
    ...
    drawCategoryFrieze(categoryEntry, ctx, options) {
